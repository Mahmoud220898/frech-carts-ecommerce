...
function Navbar() {
  const { counter, setCounter, getCart, total, setTotal } =
  ...
  return (
    <>
      <div className="navbar fixed z-50 w-full mx-auto lg:px-5 flex items-center justify-between bg-[#f0f3f2] dark:bg-gray-400 ">
        <div>
          <div className="ms-5">
            <Link
              to={"/"}
              className=" hover:border-t-cyan-950bg-slate-200 btn-gray text-xl "
            >
          ...
          <div className="ms-96 ps-12">
            <ul className="menu menu-horizontal max-md:hidden px-1  text-base ">
              <li>
                <NavLink
                  className={"sub-title  dark:text-white"}
                  to={"/products"}
                >
                  Products
                </NavLink>
        ...
        <div>
          ...
          <Link to={"/wishlist"} className="dropdown dropdown-end sub-title">
            <div
              tabIndex={0}
              role="button"
              className="btn btn-ghost btn-circle dark:hover:bg-yellow-500 dark:text-white  dark:hover:text-black"
            >
          ...
          <div className="dropdown dropdown-end sub-title  dark:text-white">
            <div
              tabIndex={0}
              role="button"
              className="btn btn-ghost btn-circle dark:hover:bg-yellow-500"
            >
              <div className="indicator">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                {counter ? (
                  <span className="badge bg-[#0aad0a] text-[#f0f3f2]  dark:text-white border-0 badge-sm indicator-item">
                    {counter}
                  </span>
                ) : (
                  ""
            ...
            >
              <div className="card-body dark:bg-black rounded-xl">
                <span className="font-extrabold text-lg dark:text-white text-center">
                  Items {counter}{" "}
                </span>
